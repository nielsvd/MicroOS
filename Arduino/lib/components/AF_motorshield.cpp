...
inline void initPWM1(void) {
    ...
    TCCR2B = FREQ_MOTOR1 & 0x7;
    OCR2A = 0;
  #elif defined(__AVR_ATmega1280__) || defined(__AVR_ATmega2560__)
    // on arduino mega, pin 11 is now PB5 (OC1A)
    TCCR1A |= _BV(COM1A1) | _BV(WGM10); // fast PWM, turn on oc1a
    TCCR1B = (FREQ_MOTOR1 & 0x7) | _BV(WGM12);
    OCR1A = 0;
  #else
...
inline void initPWM2(void) {
    ...
    TCCR2B = FREQ_MOTOR2 & 0x7;
    OCR2B = 0;
  #elif defined(__AVR_ATmega1280__) || defined(__AVR_ATmega2560__)
    // on arduino mega, pin 3 is now PE5 (OC3C)
    TCCR3A |= _BV(COM1C1) | _BV(WGM10); // fast PWM, turn on oc3c
    TCCR3B = (FREQ_MOTOR2 & 0x7) | _BV(WGM12);
    OCR3C = 0;
  #else
    #error "This chip is not supported!"
  #endif
...
inline void initPWM3(void) {
    ...
    TCCR4B = (FREQ_MOTOR3 & 0x7) | _BV(WGM12);
    //TCCR4B = 1 | _BV(WGM12);
    OCR4A = 0;
  #else
    #error "This chip is not supported!"
...
inline void initPWM4(void) {
    ...
    TCCR3B = (FREQ_MOTOR4 & 0x7) | _BV(WGM12);
    //TCCR4B = 1 | _BV(WGM12);
    OCR3A = 0;
  #else
    #error "This chip is not supported!"
